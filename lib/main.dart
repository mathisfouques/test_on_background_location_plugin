...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'BackgroundGeolocation Demo'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _onClickChangePace() {
    ...
    bg.BackgroundGeolocation.changePace((_isMoving ?? false))
        .then((bool isMoving) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          Switch(value: _enabled ?? false, onChanged: _onClickEnable),
        ],
      ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              MaterialButton(
                  minWidth: 50.0,
                  color: (_isMoving ?? false) ? Colors.red : Colors.green,
                  onPressed: _onClickChangePace,
                  child: Icon(
                      (_isMoving ?? false) ? Icons.pause : Icons.play_arrow,
                      color: Colors.white))
            ],
          ),
        ),
